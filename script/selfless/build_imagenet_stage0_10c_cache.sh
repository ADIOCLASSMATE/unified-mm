...
OUTPUT_DIR="${OUTPUT_DIR:-public/datasets/imagenet_stage0_animals10c/vae_latents_mar_kl16}"
NUM_CLASSES="${NUM_CLASSES:-10}"
MAX_SAMPLES_PER_CLASS="${MAX_SAMPLES_PER_CLASS:--1}"
SEED="${SEED:-42}"
SYNSETS="${SYNSETS:-n01443537,n01518878,n01882714,n02106662,n02123045,n02165456,n02279972,n02391049,n02504458,n02510455}"
