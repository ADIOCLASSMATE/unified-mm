...
CONFIG="${CONFIG:-configs/selfless/imagenet1k_class_dynamic_xt_800ep.yaml}"
...
RUN_ROOT="${RUN_ROOT:-output/selfless-flow-imagenet1k-class-dynamic-xt-ascend64-b1024-800ep}"
...
COMMAND=(
  ...
  --rdzv_backend static
  --same_network
  pretrain/train_selfless_flow_dynamic_xt.py
  "config=${CONFIG}"
