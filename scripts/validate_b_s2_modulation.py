#!/usr/bin/env python3
"""Audit B + S2 modulation, its parameter budget, validation images, and data assets."""
import argparse
import glob
import json
...
from utils.b_s2_modulation_protocol import CONFIG, validate_b_s2_modulation_config, parameter_report
...
def main():
    ...
    report = dict(contract=validate_b_s2_modulation_config(config), parameters=parameter_report(config),
