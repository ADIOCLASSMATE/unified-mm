...
class SelflessGenerationMixin:
    ...
    def generate_image(
        ...
        *,
        ...
        backbone_query = ImageBackboneQuery(
            model=self,
            span_starts=span_starts,
            current_sigma=current_sigma,
            batch_indices=batch_indices,
            mask_only_query=mask_only_query,
            content_then_mask_queries=content_then_mask_queries,
        ...
        def cached_query(
            ...
            *,
            ...
            return backbone_query(
                current_local_positions,
                pending_local_positions=pending_local_positions,
                cache=cache,
                image_uncond_rows=image_uncond_rows,
                label=label,
            )
